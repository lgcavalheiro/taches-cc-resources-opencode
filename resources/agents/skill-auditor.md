...
1. Read .opencode/skills/create-agent-skills/SKILL.md for overview
2. Read .opencode/skills/create-agent-skills/references/use-xml-tags.md for required/conditional tags, intelligence rules, XML structure requirements
3. Read .opencode/skills/create-agent-skills/references/skill-structure.md for YAML, naming, progressive disclosure patterns
4. Read .opencode/skills/create-agent-skills/references/common-patterns.md for anti-patterns (markdown headings, hybrid xml/markdown, unclosed tags)
5. Read .opencode/skills/create-agent-skills/references/core-principles.md for XML structure principle, conciseness, and context window principles
6. Handle edge cases:
