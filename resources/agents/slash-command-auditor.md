...
1. Read .opencode/skills/create-slash-commands/SKILL.md for overview
2. Read .opencode/skills/create-slash-commands/references/arguments.md for argument patterns
3. Read .opencode/skills/create-slash-commands/references/patterns.md for command patterns
4. Read .opencode/skills/create-slash-commands/references/tool-restrictions.md for security patterns
5. Handle edge cases:
