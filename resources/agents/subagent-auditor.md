...
1. Read .opencode/skills/create-subagents/SKILL.md for overview
2. Read .opencode/skills/create-subagents/references/subagents.md for configuration, model selection, tool security
3. Read .opencode/skills/create-subagents/references/writing-subagent-prompts.md for prompt structure and quality
4. Read .opencode/skills/create-subagents/SKILL.md section on pure XML structure requirements
