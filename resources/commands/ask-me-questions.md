...
<initial_questions>
Use ask the user a structured question with options (use the question tool or present options inline) to ask 2-4 questions based on actual gaps:
...
<decision_gate>
After receiving answers, use ask the user a structured question with options (use the question tool or present options inline):
...
2. If no context: use ask the user a structured question with options (use the question tool or present options inline) to determine task type
...
- All ask the user a structured question with options (use the question tool or present options inline) calls use structured options (not plain text questions)
