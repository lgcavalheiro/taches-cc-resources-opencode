...
2. **Parse plan and determine execution strategy:**
   ...
   **Strategy A: Fully Autonomous (no checkpoints)**
   ...
   - Subagent reads plan, executes all tasks, creates SUMMARY
...
3. **Execute based on strategy:**
   ...
   **3A: Fully Autonomous Execution**
   ...
   - Report: tasks completed, files modified"
     ...
     IF segment is autonomous:
       Spawn subagent:
         "Execute tasks [X-Y] from {{plan_path}}
          ...
          DO NOT create SUMMARY or commit. Only the main context should handle finalization.
