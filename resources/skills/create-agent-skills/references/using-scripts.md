...
<purpose>
Scripts are executable code that Opencode runs as-is rather than regenerating each time. They ensure reliable, error-free execution of repeated operations.
</purpose>
...
The workflow tells Opencode WHEN to run the script. The script handles HOW the operation executes.
</workflow_integration>
