...
<principle>
When Opencode performs complex, open-ended tasks, create a plan in a structured format, validate it, then execute.
...
Specific errors help Opencode fix issues without guessing.
</implementation_tip>
...
<principle>
Guide Opencode through decision points with clear branching logic.
</principle>
...
- Guiding Opencode to correct path improves outcomes
</when_to_use>
</conditional_workflows>

<validation_scripts>
<principles>
Validation scripts are force multipliers. They catch errors that Opencode might miss and provide actionable feedback for fixing issues.
</principles>
...
Verbose errors help Opencode fix issues in one iteration instead of multiple rounds of guessing.
</verbose_errors>
...
Actionable suggestions show Opencode exactly what to fix.
</actionable_suggestions>
...
<checkpoint_pattern>
<principle>
For long workflows, add checkpoints where Opencode can pause and verify progress before continuing.
</principle>
...
<error_recovery>
<principle>
Design workflows with clear error recovery paths. Opencode should know what to do when things go wrong.
</principle>
