...
- [references/validation-checkpoints.md#opencode-install](../references/validation-checkpoints.md#opencode-install)
...
tail -20 ~/Library/Logs/Opencode/mcp-server-{name}.log
```
</step>
...
- Changes implemented
- Server still shows ✓ Connected in `opencode mcp list`
