...
**Key insight:** PLAN.md IS the prompt that Opencode executes. Not a document that
...
- Opencode automated work needing visual/functional verification? → checkpoint:human-verify
