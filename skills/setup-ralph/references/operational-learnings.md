...
**Why:** Opencode already knows this. AGENTS.md is for project-specific knowledge.
...
### 3. The Tutorial
Don't teach programming concepts. Assume Opencode is a competent developer, just new to your project.
