...
### PROMPT_plan.md
Instructions for planning mode. Tells Opencode to:
...
### PROMPT_build.md
Instructions for building mode. Tells Opencode to:
...
### .git/
Version control. Ralph does NOT commit automatically (only when explicitly requested).
