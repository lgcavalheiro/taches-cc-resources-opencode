...
**Building mode:** Implement one task, validate
...
Select the most important task from the implementation plan, implement it correctly, validate it works. Do NOT commit automatically.
